...
My research interests include reliability and security in language models, particularly risk detection for language model-based agent systems; data mining, including next-POI recommendation; and graph learning, such as learning on imbalanced graphs, anomaly detection, and distributed GNN training.
